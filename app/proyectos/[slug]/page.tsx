...
const getProyecto = (slug: string) => {
  return {
    ...
    featuredImage: "/assets/proyecto-urbano-principal.jpg",
    gallery: ["/assets/proyecto-urbano-1.jpg", "/assets/proyecto-urbano-2.jpg", "/assets/proyecto-urbano-3.jpg"],
          ...
          <div className="border-t border-muted pt-16">
            <div className="text-center">
              ...
              <Button asChild size="lg">
                <Link href={`/proyectos/${proyecto.siguienteProyecto.slug}`}>Ver Proyecto</Link>
              </Button>
            </div>
          </div>
        )}
